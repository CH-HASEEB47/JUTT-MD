  ...
  */
    ...
    switch (command) {
      ...
      case 'sc': case 'script': case 'sourcecode': {
        ...
        let { data } = await axios.get('https://api.github.com/repos/Kai0071/JUTT-MD');
        teks = `*JUTT-MD Script*\n\n*Total Stars*: ${data.stargazers_count}⭐\n*Total Forks*: ${data.forks_count} forks\n*GitHub*: https://github.com/Kai0071/JUTT-MD\n\nDont forget to follow me on *GitHub* and give a ⭐️ to my projects. `
        /*  let buttons = [
        ...
        let buttonMessage = {
          ...
          contextInfo: {
            externalAdreply: {
              ...
              mediaUrl: 'github.com/Kai0071/JUTT-MD',
              sourceUrl: "github.com/Kai0071/JUTT-MD"
            }
          }
      ...
      case 'repo': case 'botrepo': {
        ...
        JUTT-MD.sendMessage(from, { react: { text: "💫", key: m.key } })
        reply(`⚙ My Source Code is </> - https://github.com/Kai0071/JUTT-MD`)
      }
        break;
